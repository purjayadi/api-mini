...
} from './interface/supplier.repository.interface';

@Injectable()
export class SupplierRepository
  extends BaseAbstractRepository<Supplier>
...
@Injectable()
export class SupplierBankAccountRepository
  extends BaseAbstractRepository<SupplierBankAccount>
  implements SupplierBankAccountRepositoryInterface
{
  constructor(
