...
import { ProductRepositoryInterface, UnitRepositoryInterface } from './interface/product.repository.interface';
...
@Injectable()
export class UnitRepository extends BaseAbstractRepository<Unit> implements UnitRepositoryInterface {
