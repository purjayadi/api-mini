...
let EmployeeService = class EmployeeService {
    ...
    async findAll(payload) {
        try {
            ...
            const employees = await this.repository.findAndCount(Object.assign(Object.assign({}, (limit && { take: limit })), (offset && { skip: (offset - 1) * limit })));
            return (0, hellper_1.paginateResponse)(employees, offset, limit, null, common_1.HttpStatus.OK);
        }
        catch (error) {
    ...
    async create(payload) {
        try {
            ...
            const number = (0, hellper_2.randomNumber)(10000, 99999);
    ...
    async findOne(id) {
        try {
            ...
            return { data: employee, error: null, status: common_1.HttpStatus.OK };
        }
        catch (error) {
            throw new common_1.HttpException(error.message, error.status ? common_1.HttpStatus.NOT_FOUND : common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
